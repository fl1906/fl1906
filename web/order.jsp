...
<script type="text/javascript">
	function createOrder(uid,sum) {
		//选中地址的id  document.getElementById("addressTest").value

		window.location.href= "orders?method=create&uid="+uid+"&sum="+sum+"&aid="+document.getElementById("addressTest").value;
	}
		...
		<div class="col-md-10 col-md-offset-1">
			<table class="table table-bordered table-striped table-hover">
 				...
 				<tr>
 				 <td colspan="5">
 				 	<h5>收货地址</h5>
 				 	<select id="addressTest" style="width:60%" class="form-control">
